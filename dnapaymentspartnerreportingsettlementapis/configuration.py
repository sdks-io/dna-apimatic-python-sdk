...
from dnapaymentspartnerreportingsettlementapis.http.proxy_settings import (
    ProxySettings,
)
from dnapaymentspartnerreportingsettlementapis.logging.configuration.api_logging_configuration import (  # noqa: E501
...
class Environment(Enum):
    ...
    # Test/Sandbox API server (Reporting & Settlement APIs)
    PRODUCTION = 0
    # Test/Sandbox OAuth2 authorization server
    ENVIRONMENT2 = 1
...
class Configuration(HttpClientConfiguration):
    ...
    def clone_with(self, http_client_instance=None,
        ...
        client_credentials_auth_credentials =\
            (client_credentials_auth_credentials
            or self.client_credentials_auth_credentials)
